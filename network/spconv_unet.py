    ...
    def __init__(
        ...
        if in_channels == embed_channels:
            ...
            self.proj = spconv.SparseSequential(
                ...
                norm_fn(num_channels = embed_channels),
            )
        ...
        self.bn1 = norm_fn(num_channels = embed_channels)
        self.relu = nn.ReLU()
        ...
        self.bn2 = norm_fn(num_channels = embed_channels)
        self.stride = stride
...
class SpUNetBase(nn.Module):
    def __init__(
        ...
        norm_fn = partial(nn.GroupNorm, num_groups=4)
        block = BasicBlock
        ...
        self.conv_input = spconv.SparseSequential(
            ...
            norm_fn(num_channels = base_channels),
            nn.ReLU(),
        )
        ...
        for s in range(self.num_stages):
            ...
            self.down.append(
                spconv.SparseSequential(
                    ...
                    norm_fn(num_channels = channels[s]),
                    nn.ReLU(),
                )
            )
            self.enc.append(
            ...
            self.up.append(
                spconv.SparseSequential(
                    ...
                    norm_fn(num_channels = dec_channels),
                    nn.ReLU(),
                )
            )
            self.dec.append(
    ...
    def forward(self, data_dict):
        ...
        feat = data_dict["features"]
        batch = data_dict["bs_id"]
