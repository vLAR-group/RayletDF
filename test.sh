...
CUDA_VISIBLE_DEVICES=$1 python test.py --dpt_model_path /media/HDD2/shenxing/dpt_models/release_debug/scans_gs/dpt_ckpt_0080000.pth \
    --scene_model_dir  /media/HDD2/shenxing/Scannetpp/Scannetpp_3dgs/test/ /media/HDD2/shenxing/scannet_3dgs/test/ /media/HDD2/shenxing/ARKitScenes/ARKitScenes_3dgs/test/\
                        /media/HDD2/shenxing/Multiscan/Multiscan_3dgs/test /media/HDD2/shenxing/Multiscan/Multiscan_3dgs/train\
    --scene_source_dir /media/HDD2/shenxing/Scannetpp/Scannetpp_nerf/test /media/HDD2/shenxing/scannet_nerf/scans_test /media/HDD2/shenxing/ARKitScenes/ARKitScenes_nerf/test/ \
                        /media/HDD2/shenxing/Multiscan/Multiscan_nerf/test /media/HDD2/shenxing/Multiscan/Multiscan_nerf/train\
